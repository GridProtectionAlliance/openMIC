...
namespace ConfigurationSetupUtility.Screens
{
    ...
    public partial class UserAccountCredentialsSetupScreen : UserControl, IScreen
    {
        ...
        private void RadioButtonWindowsAuthentication_Checked(object sender, RoutedEventArgs e)
        {
            ...
            MessageTextBlock.Text = "Please enter current credentials for the Windows authenticated user setup to be the administrator for openMIC. Credentials validated by operating system.";
        ...
        private void RadioButtonWindowsAuthentication_Unchecked(object sender, RoutedEventArgs e)
        {
            ...
            MessageTextBlock.Text = "Please provide the desired credentials for database user setup to be the administrator for openMIC. Password complexity rules apply.";
