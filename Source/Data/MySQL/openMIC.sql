--  ----------------------------------------------------------------------------------------------------
--  openMIC Data Structures for MySQL - Gbtc
--
...
CREATE DATABASE openMIC CHARACTER SET = UTF8;
USE openMIC;
...
-- GRANT SELECT, UPDATE, INSERT, DELETE ON openMIC.* TO NewUser;
...
CREATE TABLE NodeCheckin(
    ...
    CONSTRAINT IX_NodeCheckin_URL_Task UNIQUE KEY (URL ASC, Task ASC)
);
