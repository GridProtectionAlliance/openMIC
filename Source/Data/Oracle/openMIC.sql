--  ----------------------------------------------------------------------------------------------------
--  openMIC Data Structures for Oracle - Gbtc
--
...
-- CREATE TABLESPACE openMIC_TS DATAFILE 'openMIC.dbf' SIZE 20M AUTOEXTEND ON;
-- CREATE TABLESPACE openMIC_INDEX DATAFILE 'openMIC_index.dbf' SIZE 20M AUTOEXTEND ON;
-- CREATE USER openMIC IDENTIFIED BY MyPassword DEFAULT TABLESPACE openMIC_TS;
-- GRANT UNLIMITED TABLESPACE TO openMIC;
-- GRANT CREATE SESSION TO openMIC;
-- ALTER SESSION SET CURRENT_SCHEMA = openMIC;
...
CREATE UNIQUE INDEX IX_ErrorLog_ID ON ErrorLog (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Runtime_Source ON Runtime (SourceID ASC, SourceTable ASC) TABLESPACE openMIC_INDEX;

CREATE UNIQUE INDEX IX_Runtime_ID ON Runtime (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_AuditLog_ID ON AuditLog (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Company_ID ON Company (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_TrackedChange_ID ON TrackedChange (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Vendor_ID ON Vendor (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Protocol_ID ON Protocol (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_SignalType_ID ON SignalType (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Interconnection_ID ON Interconnection (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Node_ID ON Node (ID ASC) TABLESPACE openMIC_INDEX;

CREATE UNIQUE INDEX IX_Node_Name ON Node (Name ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_OtherDevice_ID ON OtherDevice (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Device_ID ON Device (ID ASC) TABLESPACE openMIC_INDEX;

CREATE UNIQUE INDEX IX_Device_UniqueID ON Device (UniqueID ASC) TABLESPACE openMIC_INDEX;

CREATE UNIQUE INDEX IX_Device_NodeID_Acronym ON Device (NodeID ASC, Acronym ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_VendorDevice_ID ON VendorDevice (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_OutStreamDevDigital_ID ON OutputStreamDeviceDigital (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_OutStreamDevPhasor ON OutputStreamDevicePhasor (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_OutStreamDevAnalog ON OutputStreamDeviceAnalog (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Measurement_SignalID ON Measurement (SignalID ASC) TABLESPACE openMIC_INDEX;

CREATE UNIQUE INDEX IX_Measurement_PointID ON Measurement (PointID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Statistic_ID ON Statistic (ID ASC) TABLESPACE openMIC_INDEX;

CREATE UNIQUE INDEX IX_Statistic_Source_SigIndex ON Statistic (Source ASC, SignalIndex ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_OutputStreamMeasurement_ID ON OutputStreamMeasurement (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_OutputStreamDevice_ID ON OutputStreamDevice (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Phasor_ID ON Phasor (ID ASC) TABLESPACE openMIC_INDEX;
CREATE UNIQUE INDEX IX_Phasor_DeviceID_SrcIndex ON Phasor (DeviceID ASC, SourceIndex ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_CalculatedMeasurement_ID ON CalculatedMeasurement (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_CustomActionAdapter_ID ON CustomActionAdapter (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Historian_ID ON Historian (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_CustomInputAdapter ON CustomInputAdapter (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_CustomFilterAdapter ON CustomFilterAdapter (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_OutputStream_ID ON OutputStream (ID ASC) TABLESPACE openMIC_INDEX;

CREATE UNIQUE INDEX IX_OutputStream_NodeID_Acronym ON OutputStream (NodeID ASC, Acronym ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Alarm_ID ON Alarm (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_AlarmLog_ID ON AlarmLog (ID ASC) TABLESPACE openMIC_INDEX;
CREATE INDEX IX_AlarmLog_SignalID ON AlarmLog (SignalID ASC) TABLESPACE openMIC_INDEX;
CREATE INDEX IX_AlarmLog_PreviousState ON AlarmLog (PreviousState ASC) TABLESPACE openMIC_INDEX;
CREATE INDEX IX_AlarmLog_NewState ON AlarmLog (NewState ASC) TABLESPACE openMIC_INDEX;
CREATE INDEX IX_AlarmLog_Timestamp ON AlarmLog (Timestamp ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_CustomOutputAdapter_ID ON CustomOutputAdapter (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_AccessLog_ID ON AccessLog (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_UserAccount_ID ON UserAccount (ID ASC) TABLESPACE openMIC_INDEX;

CREATE UNIQUE INDEX IX_UserAccount_Name ON UserAccount (Name ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_SecurityGroup_ID ON SecurityGroup (ID ASC) TABLESPACE openMIC_INDEX;

CREATE UNIQUE INDEX IX_SecurityGroup_Name ON SecurityGroup (Name ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_ApplicationRole_ID ON ApplicationRole (ID ASC) TABLESPACE openMIC_INDEX;

CREATE UNIQUE INDEX IX_ApplicationRole_NodeID_Name ON ApplicationRole (NodeID ASC, Name ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_Subscriber_NodeID_ID ON Subscriber (NodeID ASC, ID ASC) TABLESPACE openMIC_INDEX;

CREATE UNIQUE INDEX IX_Subscriber_NodeID_Acronym ON Subscriber (NodeID ASC, Acronym ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_SubscriberMeasurement ON SubscriberMeasurement (NodeID ASC, SubscriberID ASC, SignalID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_SubscriberMeasurementGroup ON SubscriberMeasurementGroup (NodeID ASC, SubscriberID ASC, MeasurementGroupID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_MeasurementGroup_ID ON MeasurementGroup (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_MeasurementGroupMeasurement ON MeasurementGroupMeasurement (NodeID ASC, MeasurementGroupID ASC, SignalID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_AlarmState_ID ON AlarmState (ID ASC) TABLESPACE openMIC_INDEX;
...
CREATE UNIQUE INDEX IX_AlarmDevice_ID ON AlarmDevice (ID ASC) TABLESPACE openMIC_INDEX;
