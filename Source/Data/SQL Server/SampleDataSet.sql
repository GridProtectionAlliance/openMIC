...
GO
INSERT INTO Device(NodeID, Acronym, Name, IsConcentrator, CompanyID, HistorianID, AccessID, VendorDeviceID, ProtocolID, Longitude, Latitude, InterconnectionID, ConnectionString, MeasuredLines, LoadOrder, Enabled) VALUES('8a8d1856-ebc8-4238-848a-8084b7dd9541', 'TESTDEVICE', 'Test Device', 0, 30, 1, 2, 2, 4, -89.8038, 35.3871, 1, 'transportProtocol=File; file=Sample1344.PmuCapture; useHighResolutionInputTimer=True', 3, 0, 1)
GO
...
GO
INSERT INTO ApplicationRole (Name, Description, NodeID) VALUES ('Editor', 'Editor Role', '8a8d1856-ebc8-4238-848a-8084b7dd9541')
GO
