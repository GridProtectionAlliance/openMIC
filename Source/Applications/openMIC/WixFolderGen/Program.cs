...
namespace WixFolderGen
{
    class Program
    {
        ...
        const string SolutionRelativeRootFolder = "Applications\\openMIC\\openMIC\\" + RootFolderName;

        // Following paths are relative to build output location
        const string ApplicationPath = "..\\..\\..\\..\\..\\Source\\Applications\\openMIC";
        const string SourceFolder = ApplicationPath + "\\openMIC\\" + RootFolderName;
        const string WebFeaturesDestinationFile = ApplicationPath + "\\openMICSetup\\WebFeatures.wxi";
        const string WebFoldersDestinationFile = ApplicationPath + "\\openMICSetup\\WebFolders.wxi";
        const string WebFilesDestinationFile = ApplicationPath + "\\openMICSetup\\WebFiles.wxi";
