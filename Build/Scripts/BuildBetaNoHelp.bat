...
@ECHO OFF
"C:\Program Files (x86)\MSBuild\14.0\Bin\MSBuild.exe" openMIC.buildproj /p:ForceBuild=true;SkipHelpFiles=true /l:FileLogger,Microsoft.Build.Engine;logfile=openMIC.output