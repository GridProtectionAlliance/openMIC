...
ECHO BuildNightly: C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\msbuild.exe openMIC.buildproj /p:ForceBuild=false %logflag%
"C:\Program Files (x86)\MSBuild\14.0\Bin\MSBuild.exe" openMIC.buildproj /p:ForceBuild=false %logFlag%